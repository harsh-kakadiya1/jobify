...
function CompaniesTable() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 mt-8">
      <Table>
        <TableCaption className="text-gray-500">List of your recent registed company</TableCaption>
        <TableHeader>
          <TableRow>
              ...
              <TableRow key={company._id} className="hover:bg-blue-50 transition">
                ...
                <TableCell className="text-right cursor-pointer">
                  <Popover>
                    ...
                    <PopoverContent className="w-24 rounded-lg shadow-lg p-2">
                      <div onClick={()=>navigate(`/admin/companies/${company._id}`)} className="flex items-center gap-2 w-fit cursor-pointer hover:bg-blue-100 rounded px-2 py-1">
                        <Edit2 className="w-4" />
                        <span>Edit</span>
                      </div>
                    </PopoverContent>
